...
| brewery_id  | INTEGER      | Brasserie productrice   | REFERENCES brewery(id) |
...
| user_id    | INTEGER     | Auteur de l'avis                | REFERENCES user(id)                      |
| beer_id    | INTEGER     | Bière concernée (si applicable) | REFERENCES beer(id)                      |
...
| created_at | TIMESTAMPTZ | Date de l'avis                      | NOT NULL DEFAULT NOW()                   |
| user_id    | INTEGER     | Auteur de l'avis                    | REFERENCES user(id)                      |
| brewery_id | INTEGER     | Brasserie concernée (si applicable) | REFERENCES brewery(id)                   |
